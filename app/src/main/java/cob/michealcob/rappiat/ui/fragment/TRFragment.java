...
public class TRFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = view.findViewById(R.id.rv_tr);
        ...
        movieList = movieDB.getAllMoviesTR();
    ...
    private void loadOnline() {
        ...
        final Call<ApiResponse> popularFragmentCall = apiService.getTopResponse(key);
