...
public class UpcomingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = view.findViewById(R.id.rv_upcoming);
        ...
        movieList = movieDB.getAllMoviesUpcoming();
    ...
    private void loadOnline() {
        ...
        final Call<ApiResponse> popularFragmentCall = apiService.getUpcomingResponse(key);
        ...
        popularFragmentCall.enqueue(new Callback<ApiResponse>() {
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                for (int i=0;i<result.size();i++){
                    ...
                    movieDB1.createMovieUpcoming(movie);
